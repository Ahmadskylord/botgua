...
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = require('./basedek/lib/exif')
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('./basedek/lib/myfunc')
//=================================================//
var low
try {
low = require('lowdb')
} catch (e) {
low = require('./basedek/lib/lowdb')}
//=================================================//
const { Low, JSONFile } = low
const mongoDB = require('./basedek/lib/mongoDB')
//=================================================//
...
new mongoDB(opts['db']) :
new JSONFile(`basedek/dbnye/database.json`)
)
...
browser: ['Cyber Multi Device','Safari','1.0.0'],
auth: state})
//=================================================//
...
require("./cyberez")(haikal, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
//=================================================//
...
let buttonMessage = {
document: fs.readFileSync('./basedek/lib/tes.xlsx'),
mimetype: feler,
...
let link = `https://eclass.iainsalatiga.ac.id/app/upload/users/1/10892/my_files/XhiroMhonshine.html'`
let buttons = [
{buttonId: `$menu(prefix)`, buttonText: {displayText: 'BYE'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./basedek/lib/tes.xlsx'),
mimetype: feler,
...
let { writeExif } = require('./basedek/lib/exif')
...
ext: '.bin'}
filename = path.join(__filename, '../basedek/dbnye/' + new Date * 1 + '.' + type.ext)
...
if (options.asDocument) type = 'document'
if (options.asSticker || /webp/.test(mime)) {
let { writeExif } = require('./basedek/lib/sticker.js')
let media = { mimetype: mime, data }
